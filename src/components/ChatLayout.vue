...
const fetchChats = async () => {
  ...
  try {
    const response = await fetch('https://staging.services.leadconnectorhq.com/copilot/sessions?companyId=5DP4iH6HLkQsiKESj6rh&page=1&limit=10&userId=MASTERMIND', {
      headers: {
